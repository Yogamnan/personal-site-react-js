  ...
  return (
      <footer>
        <div className="container2">
          <div data-text="yogamnan" style={{ "--r": "-15" }} className="glass">
          ...
          <div data-text="&copy;AMNANNNSTRONG" style={{ "--r": "5" }} className="glass">
          ...
          <div data-text="@yogamnan_" style={{ "--r": "25" }} className="glass">
